    ...
    <div class="card-body login-card-body">
      ...
      <form action="../../index3.html" method="post">
        <div class="input-group mb-3">
          <input type="email" class="form-control" placeholder="Usuário" value="admin">
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <a href="<?php echo base_url() . 'produtos' ?>" class="btn btn-primary btn-block btn-flat">Entrar</a>
          </div>
          <!-- /.col -->
        </div>
      </form>
