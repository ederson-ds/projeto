...
class Receitas_model extends CI_Model {
    ...
    public function get($id) {
        ...
        $query = $this->db->query("SELECT * FROM receitas WHERE id = $id");
        return $query->row();
    }
    ...
    public function insert($id) {
        ...
        $this->db->insert('receitas', $this);
    }

    public function update($id) {
        $this->db->update('receitas', $this, array('id' => $id));
    }

    public function delete($id) {
        $this->db->delete('receitas', array('id' => $id));
    }
